    ...
    <div style="margin-left: 20px">
        <#if isAdmin??>
            ...
            <ul class="circle" style="font-size: 20px">
                ...
                <hr class="disck"><li><a href="/getUniversityVendingMachine">Аппараты в университетах</a></li>
                <hr class="disck"><li><a href="/getBussisnessVendingMachine">Аппараты-бизнес центрах</a></li>
            </ul>
            <br>
        </#if>
        <h2>Аппараты пользователя</h2>
        <ul class="circle" style="font-size: 20px">
            <hr class="disck"><li><a href="/getUserVendingMachine">Аппараты</a></li>
        </ul>
    </div>
