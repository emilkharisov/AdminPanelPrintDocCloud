        ...
        <div class="user_card">
            <div class="d-flex justify-content-center">
                <div class="brand_logo_container">
                    <img src="/static/img/PrintDocCloud.png" class="brand_logo" alt="Logo">
                </div>
            </div>
            <div class="d-flex justify-content-center form_container">
                <form method="post" action="/login">
                    <div class="input-group mb-3">
                        ...
                        <input type="text" id="login" name="login" class="form-control input_user" value="" placeholder="Логин">
                    </div>
